...
{
	return { 1.0f, 0, 0, 0,
					0, (float)cos(3.14159265 / 180 * angle), (float)sin(3.14159265 / 180 * angle), 0,
					0, (float)-sin(3.14159265 / 180 * angle),(float)cos(3.14159265 / 180 * angle), 0,
					0, 0, 0, 1.0f };
}
Matrix Matrix::YRotationMatrix(float angle)
{
	return {(float)cos(3.14159265 / 180 * angle), 0, (float)-sin(3.14159265 / 180 * angle), 0,
			0, 1.0f, 0, 0,
			(float)sin(3.14159265 / 180 * angle), 0, (float)cos(3.14159265 / 180 * angle), 0,
			0, 0, 0, 1.0f };
}
Matrix Matrix::ZRotationMatrix(float angle)
{
	return { (float)cos(3.14159265 / 180 * angle), (float)sin(3.14159265 / 180 * angle), 0, 0,
		(float)-sin(3.14159265 / 180 * angle), (float)cos(3.14159265 / 180 * angle), 0, 0,
		0, 0, 1.0f, 0,
		0, 0, 0, 1.0f };
}
